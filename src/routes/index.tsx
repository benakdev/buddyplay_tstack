			...
			<div className="relative z-10 flex w-full max-w-5xl flex-col items-center text-center">
				...
				>
					<SignUpButton mode="modal">
						<button className="group bg-primary text-primary-foreground hover:bg-primary/90 relative inline-flex h-16 w-full min-w-[220px] items-center justify-center overflow-hidden px-8 text-xl font-bold tracking-wide uppercase transition-all hover:scale-[1.02] sm:w-auto">
					...
					<SignInButton mode="modal">
						<button className="group border-primary/20 text-foreground hover:border-primary hover:text-primary inline-flex h-16 w-full min-w-[160px] items-center justify-center border-2 bg-transparent px-8 text-xl font-bold tracking-wide uppercase transition-all sm:w-auto">
							Sign In
						</button>
					</SignInButton>
				</motion.div>
